...
<form action="add_quote.php" method="post">
	<p><label>Quote <textarea name="quote" rows="5" cols="30"><?php if (isset($_POST['quote'])) { print "{$_POST['quote']}";  } ?>
	</textarea></label></p>
	<p><label>Source <input type="text" name="source" <?php if (isset($_POST['source'])) {
		print ' value="' . $_POST['source'] . '" ';
	} ?> /></label></p>
	<p><label>Is this a favorite? <input type="checkbox" name="favorite" value="yes" <?php 
		if (isset($_POST['favorite'])) { 
			print ' checked="true" ';
		}
	?> /></label></p>
